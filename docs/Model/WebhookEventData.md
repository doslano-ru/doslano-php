...
**inventory_pdf** | **string** | Ссылка на скачивание PDF описи вложения, сформированной сервисом, через наш API. Присутствует в &#x60;recipient.sent&#x60; и &#x60;recipient.delivered&#x60;, когда опись сформирована. | [optional]
