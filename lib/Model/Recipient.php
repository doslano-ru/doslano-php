...
class Recipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets inventory_pdf
     *
     * @param string|null $inventory_pdf Ссылка на скачивание PDF описи вложения, сформированной сервисом, через наш API (см. `GET /v1/letters/{id}/recipients/{recipient_id}/inventory.pdf`). Присутствует, когда опись сформирована и отправление передано в Почту (получатель в статусе `sent`/`delivered`).
     *
     * @return self
     */
