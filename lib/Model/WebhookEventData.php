...
class WebhookEventData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets inventory_pdf
     *
     * @param string|null $inventory_pdf Ссылка на скачивание PDF описи вложения, сформированной сервисом, через наш API. Присутствует в `recipient.sent` и `recipient.delivered`, когда опись сформирована.
     *
     * @return self
     */
